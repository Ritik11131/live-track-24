...
export class LayoutService {
    private closeSidebar = new Subject<boolean>();
    isCustomer: boolean = true;
    currentToken:string="";
    
    closeNavbar = this.closeSidebar.asObservable();
    _config: AppConfig = {
        ripple: false,
        inputStyle: 'outlined',
        menuMode: 'slim-plus',
    ...
    checkCustomerRole() {
        ...
        this.isCustomer=decoded.role=="2";
    }
    ...
    closeSidebarFunction(close: boolean = false) {
        this.closeSidebar.next(close);
      }
}
